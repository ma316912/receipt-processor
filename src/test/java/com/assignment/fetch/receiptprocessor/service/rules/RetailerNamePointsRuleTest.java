...
class RetailerNamePointsRuleTest {

    private RetailerNamePointsRule retailerNamePointsRule;
    private Receipt validReceipt;

    @BeforeEach
    void setUp() {
        retailerNamePointsRule = new RetailerNamePointsRule();
    ...
    @Test
    void shouldCalculatePointsForAlphanumericRetailerNameTest() {
        int points = retailerNamePointsRule.calculatePoints(validReceipt);
